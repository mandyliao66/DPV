...
//  float pulseWidth_ms; //added
//  float quietTime_ms; //added
...
/* DPV parameters  */
  uint32_t  StepNumber;
  float     StepHeight_mV;        // replaces DACCodePerRamp 
  float     PulseAmplitude_mV;    // replaces SqrWvAmplitude
  float     PulseWidth_ms;        // 
  float     QuietTime_ms;         // 
...
/* Internal / runtime */
  BoolFlag      DPVInited;        // renamed from SWVInited
